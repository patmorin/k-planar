...
A secondary issue is that a number of the proofs in this section are essentially "definition checking".  The relationships between the various vertex sets that arise in the proof really do just follow from their definitions (which were made with this purpose in mind).  We have done this checking explicitly, though each of these proofs could also be replaced by a sentence of the form ``This [claim/lemma] follows from the definitions of\ldots''.  It is not clear what the best choice is.
