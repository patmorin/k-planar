...
\begin{compactitem}
  ...
  %\note{DW}{We actually make a stronger assumption than bounded degree; we assume each string is crossed at most $k$ times. I am happy to leave our write-up as is, but be aware of the difference. }
  string graphs, powers of bounded-degree graphs, map graphs of bounded clique number, and $k$-nearest neighbour graphs.
