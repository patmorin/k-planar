...
\note{DW}{The graph drawing literature defines a 1-planar graph to be \defin{optimal} if it is obtained from a plane quadrangulation by adding the two crossing edges across each face. Optimal 1-planar graphs have the maximum number of edges out of all $n$-vertex 1-planar graphs.	But I am pretty sure there are edge-maximal 1-planar graphs that are not optimal. We should check that our proof is okay on these examples. }
...
\note{DW}{We do not want to uncross.}
