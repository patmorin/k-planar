...
Although $k$-planar graphs are the most high-profile target for a generalization of \cref{PlanarBasic}, we actually prove a substantially stronger result than \cref{kPlanarBasic} using the following definition. A collection $\mathcal{P}$ of paths in a graph $G$ is a \emph{$(k,d)$-shortcut system} (for $G$) if:
\begin{compactitem}
...
\citet{dujmovic.joret.ea:planar} proved that if a graph $G$ has an $H$-partition with layered width at most $\ell$ such that $H$ has treewidth at most $k$, then $G$ has layered treewidth at most $(k+1)\ell$. 
...
\newblock In Therese~C. Biedl and Andreas Kerren, editors, \emph{Proc. 26th
  ...
  2018), vol.~11282 of \emph{Lecture Notes in Computer Science}, pp.~213--226. Springer, 2018.
...
\newblock In S.~Cabello and B.~Mohar, editors, \emph{9th Slovenian
  International Conference on Graph Theory} (SICGT), page~63, June 2019.

\bibitem[Bose et~al.(2001)Bose, Morin, Stojmenović, and
  Urrutia]{bose.morin.ea:routing}
Prosenjit Bose, Pat Morin, Ivan Stojmenovi\'c, and Jorge Urrutia.
...
Prosenjit Bose, Vida Dujmovi\'c, Ferran Hurtado, John Iacono, Stefan Langerman,
  Henk Meijer, Vera Sacrist\'an, Maria Saumell, and David~R. Wood.
...
\bibitem[D{\k e}bski et~al.(2019)D{\k e}bski, Felsner, Micek, and Schr{\"
  o}der]{micek:personal}
  Micha{\l} D{\k e}bski, Stefan Felsner, Piotr Micek, and Felix Schr{\" o}der. 
...
\newblock Johns Hopkins Univ.\ Press, 2001.
