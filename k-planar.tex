...
\begin{enumerate}[(PR1)]
  ...
  \begin{compactenum}
    ...
    \item $F[P_i]$ is a cycle and there exists an edge of $F[P_i]$ whose removal produces a path that is contained in $Y_a$ for some $K$-ancestor $a$ of $x$; or 
    \item $F[P_i]\subseteq F_{r_K}$.
  \end{compactenum}
