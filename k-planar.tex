...
The following result shows that $k$-planar graphs admit bounded layered partitions. With \cref{PartitionProduct,MakeWidth1}, this proves \cref{kPlanarBasic}. % with $c_k\leq(4+o(1))k^5$.
...
$$\chi_p(G)\le (p+1) (t+1)\tbinom{p+t}{t}.$$
%$\chi_p(G)\le p^{O(k^3)}$.
%Every $k$-planar graph has a layered $H$-partition of layered width at most $18k^2 + 30k$ in which $H$ has treewidth at most $\binom{k+4}{3}-1$. %$\treewidth$.
%Every graph $G$ that has a layered $H$-partition of layered width at most $\ell$ in which $H$ has treewidth at most $t$ satisfies $\chi_p(G)\le \ell (p+1) (t+1)\binom{p+t}{t}$. 
\end{cor}
...
Then $G^k$ has a layered $H$-partition of layered width at most $\max\{2g,3\} (2k^4+2k^3+8k^2) \Delta^{k} $ for some graph $J$ with treewidth at most $\binom{k+4}{4}-1$.
\end{thm}
...
$$\max\{2g,3\} (6k^4+6k^3+24k^6) \,\Delta^{k}\, 2^{\binom{k+4}{4}-1},$$
...
$$\max\{2g,3\} (2k^4+2k^3+8k^2) \Delta^{k}  (p+1) (t+1)\tbinom{p+t}{t}$$
