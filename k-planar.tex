...
\begin{proof}
  ...
  Therefore, we can apply induction using the cycle $F_i$ and the partition $P_1',P_2',P_3'$ of $V(F_i)$ to obtain the desired $H$-partition $\mathcal{P}_i$ and tree decomposition of subgraph $N_i$ of $G$ contained in $F_i$.
