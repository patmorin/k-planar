...
\note{DW}{I wonder if one can get treewidth 3 for $(g,1)$-planar graphs, combining the method in \cref{1-planar} with \citep{DHHW}. Perhaps this should be in another paper?}
...
\note{DW}{I wonder if one can get treewidth 3 here using \cref{framed} and \citep{DHHW}. 
Perhaps this should be in another paper?}
