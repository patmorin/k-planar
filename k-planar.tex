...
\begin{proof}
  ...
  \clmref{i-ancestor} ensures that, for every edge $ax'\in E(J)$, $a,x'\in C_{x'}$ and the connectivity of $T[a]:=T[\{x\in V(T):a\in C_x]$ is obvious.  Therefore $(C_x:x\in V(T))$ is indeed a tree-decomposition of $J$.  What remains is to bound the size, $\max\{|C_x|:x\in V(T)\}$, of the largest bag.
...
% $\max\{(48+o(1))g\delta^4, (72+o(1))\delta^4\}$ in which $H$ has treewidth at most $(\frac{4}{3}+o(1)) \delta^6$.
$\max\{(48+o(1))g\delta^4, (72+o(1))\delta^4\}$ in which $H$ has treewidth at most $(\frac{2}{3}+o(1)) \delta^8$.
% tw = 2\delta+5 choose 4 - 1  , for g > 1.
\end{prop}
