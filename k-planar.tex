...
\begin{thm}
\label{k-planar}
Every $k$-planar graph has a layered $H$-partition of layered width at most $18k^2 + 30k$ in which $H$ has treewidth at most $\treewidth$.
\end{thm}
...
\note{PM}{By now this rough characterization is closely related to $(k+1,2)$-shortcut systems.  Let's think about how to present this.}
