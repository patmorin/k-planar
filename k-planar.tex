...
\note{DW}{Suggested section name ``Graphs Derived From Framed Graphs'' or just 
``Framed Graphs''}
...
I suggest we write, ``we proceed by  
induction on $(x,y)$ where $x$ is the number of inner vertices of $N_0$ and $y$ is the number of inner faces of $N_0$. ''}
