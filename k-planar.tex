...
For any integer $d\ge 3$, a (multi)graph $G$ is \defin{$d$-framed} if it admits a drawing in the plane having a biconnected plane (multi) subgraph $G_0$, whose facial cycles have length at most $d$,  and such that the interior of each edge in $E(G)\setminus E(G_0)$ is contained in the interior of some face of $G_0$.
