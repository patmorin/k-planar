...
\note{DW}{I think $\binom{k+t}{t}$ in \cref{general-bag-size} and $\binom{p+t}{t}$ in \cref{p-centered-treewidth} are no coincidence. The proofs are very similar. Worth exploring further?}
