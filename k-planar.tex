...
\begin{proof}
  ...
  \begin{compactenum}[(i)]
    \item To see that $H$ is planar, observe that $N/\mathcal{P}=N'/\mathcal{P}$\todo{Explain why $N/\mathcal{P}=N'/\mathcal{P}$} and that each part $P\in\mathcal{P}$ induces a connected subgraph $G'[P]$ of $G'$.  Since $G'$ is planar and planarity is preserved under edge contractions, this implies that $G'/\mathcal{P}$ is planar.
