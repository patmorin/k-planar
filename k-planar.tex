...
\begin{proof}
  ...
  \note{PM}{The longwinded version is that induction is on the pair $(x,y)$ where $x=|V(N-F)|$ and $y$ is the number of inner faces of $N'$.  The base cases are $(0,y)$ for any $y$.}
