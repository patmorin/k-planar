...
\begin{table}
  \begin{center}
    \begin{tabular}{lccl}
      ...
      $(g,d)$-map & $\textcolor{red}{?}$ & $\textcolor{red}{?}$ & \textcolor{red}{\cref{dMapProduct}} \\ \hline
      \\[.2ex]
...
\citet{ABGKP20} proved that every planar graph with treewidth at most $3$ has queue-number at most $5$. Thus the graph $H$ in \cref{1_planar_product} has queue-number at most $5$. \cref{qn,1_planar_product,dMapProduct} then imply:
