...
\begin{proof}
  ...
  \begin{equation}
     |\{\delta\in\{d_1,\ldots,d_0-1\}:  \mbox{there exists a $\delta$-walk} \}| \le \binom{k+3}{2} \enspace . \eqlabel{one-round}
  \end{equation}
  \begin{figure}
    \begin{center}
  ...
  \[
      \sum_{s=0}^{k+1} \binom{k+3-s}{2}
      = \sum_{s=2}^{k+3} \binom{s}{2} 
      = \frac{1}{6}(k+2)(k+3)(k+4) 
      = \frac{k^3}{6} + \frac{3k^2}{2} + \frac{13k}{3} + 4 \ge |B_x| \enspace . \qedhere
  \]
\end{proof}
