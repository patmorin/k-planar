...
diagonals will do.}  Are they correct? If so, what to do?} Indeed, \citet{dujmovic.eppstein.ea:structure} construct 1-planar graphs that contain arbitrarily large complete graph minors. Our results for $k$-planar graphs are the first of this type for a non-minor-closed class.
...
\citet{pilipczuk.siebertz:polynomial-soda} and \citet{debski.felsner.ea:improved} use \cref{thm:ps} and \cref{PlanarPartition}.\ref{subthm:three-tree}
