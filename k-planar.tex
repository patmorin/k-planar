...
\begin{proof}[Proof of \thmref{g-k-planar}]
  ...
  Summarizing, we obtain an $H'$-partition $(\mathcal{L},\mathcal{P}')$ of $G$ where, for each $P\in\mathcal{P}'$,
  \[ |V_i' \cap P| \le \begin{cases} 8gk^2+12gk+4g & \text{if $P=Z'$} \\
                                      30 & \text{if $P\neq Z'$ and $k=1$} \\
                                  24k^2+36k+12 & \text{otherwise.} 
                    \end{cases}
  \]
  and $H'$ has treewidth 
  \[
